export default function Q2() {
  return (
     <div style={{ textAlign: 'center', marginTop: '50px' }}>
      ...
      <b />
      Next.js (full framework) has additional tooling and supports out of the box support for Typescript, hot reloading without component state loss, bunding, route opre-fetching, hybrid rendering.
